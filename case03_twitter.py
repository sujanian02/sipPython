...
consumerKey='BnJhaZr7foa1vsI1mYMlwu8yI'
consumerSecret='lyCBA05DpbPGBwfv2LdHNnj8QHzH9A1mb2wKZk5ABcpGNkZTV1'
AccessToken='843422747195822080-r64SCjBRhUqZ53Jf6FwmgiY5Qk9YLDv'
AccessTokenSecret='yRmh0mWHuGI9yqYRSmHNnkPIu6Z1DVOAizLZzS8Kqdb1Q' 
...
for tweet in tweepy.Cursor(api.search, q="@prashar_mayank", count=100, lang="en", since = "2017-07-20").items():
    print(tweet.created_at, tweet.text)
    csvWriter.writerow([tweet.created_at, tweet.text.encode('utf-8')])
    
csvFile = open('ua.csv','a')
csvWriter = csv.writer(csvFile)
for tweet in tweepy.Cursor(api.search, q="#ICC", count=100, lang="en", since = "2019-07-21").items():
    print(tweet.created_at, tweet.text)
    csvWriter.writerow([tweet.created_at, tweet.text.encode('utf-8')])
                 
csvFile = open('icc.csv','a')
csvWriter = csv.writer(csvFile)
for tweet in tweepy.Cursor(api.search, q="#ICC", count=100, lang="en", since = "2019-06-21").items():
    print(tweet.created_at, tweet.text)
    csvWriter.writerow([tweet.created_at, tweet.text.encode('utf-8')])
